ActionController::Routing::Routes.draw do |map|
  ...
  map.resources :questions, :member => { :num_votes_by_visitor_id => :get, :export => :post, :set_autoactivate_ideas_from_abroad => :put,  :activate => :put, :suspend => :put}, :collection => {:recent_votes_by_question_id => :get} do |question|
